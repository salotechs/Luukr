            ...
            <section className={`py-8 rounded-lg border-2 ${isDark ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
              <div className="px-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                      <path d="M3.609,1.814L13.792,12l-10.183,10.186C3.234,22.408 3,21.771 3,21.057V2.943C3,2.229 3.234,1.592 3.609,1.814M5.828,2.556l8.591,8.592L5.828,19.74V2.556M18.464,6.209L7.071,17.602l11.393,11.393c0.385,0.385 0.916,0.6 1.457,0.6c0.541,0 1.071,-0.215 1.457,-0.6l8.593,-8.592L18.464,6.209" />
                    </svg>
                    Google Play
                  </a>
                </div>
